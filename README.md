# INF43-5PM-Discussion-Group5
Friend Finder Design
Date: 4/15/2026   Type: In-person
Attendees: Makani Melendrez, Keya Negandhi, Jungmin Han, Daniel Tan, Anirudh Ravishankar
Summary: Discussed what features we are going to support within the FindMe Friends software that we will eventually build. We decided on including the following features but our prototype might support some of these features but not all of them; range of specific person, require a real name, private and public setting, and the bios, etc.

Date: 4/22/2026   Type: In-person
Attendees: Makani Melendrez, Keya Negandhi, Jungmin Han, Daniel Tan, Anirudh Ravishankar
Summary: Created a short pitch of our potential product that included the hook, the actual pitch, and key features that make our team stand out. We centered our pitch on differentiating ourselves from other groups who in the real world would be our competitors by highlighting our unique features that other groups do not have. We also worked on our requirements specification page, where we made a plan on how to complete it on time.

Date: 4/29/2026   Type: In-person
Attendees: Makani Melendrez, Keya Negandhi, Jungmin Han, Daniel Tan, Anirudh Ravishankar
Summary: We discussed the INF 43 project titled FindMe Friends and assignment two. We split up our roles for the week by having everyone first get themselves familiar with the scope of the project and further increase our knowledge on architecture. So that next week for our discussion we are well equipped to complete all the requirements to HW2.
